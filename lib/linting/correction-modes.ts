...
export const CORRECTION_MODES: Record<CorrectionModeId, CorrectionMode> = {
  novel: {
    ...
    defaultGuidelines: ["editors-rulebook", "gendai-kanazukai-1986", "genji-dict"],
    ruleOverrides: {},
  },
  official: {
    id: "official",
    ...
    defaultGuidelines: ["jtf-style-3", "gendai-kanazukai-1986", "genji-dict"],
    ruleOverrides: {},
  },
  blog: {
    id: "blog",
    ...
    defaultGuidelines: ["editors-rulebook", "genji-dict"],
    ruleOverrides: {},
  },
  academic: {
    id: "academic",
  ...
  sns: {
    ...
    defaultGuidelines: ["gendai-kanazukai-1986", "genji-dict"],
    ruleOverrides: {},
  },
};
...
/**
 * Maps each correction mode to the corresponding LINT_PRESETS key.
 * Used when switching modes to apply the appropriate rule configuration.
 */
export const MODE_TO_PRESET: Record<CorrectionModeId, string> = {
  novel: "novel",
  official: "strict",
  blog: "standard",
  academic: "strict",
