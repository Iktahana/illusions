...
const LOCAL_FONT_FAMILY_SET = new Set<string>([...LOCAL_SYSTEM_FONTS.map((f) => f.family)]);
...
export function isElectronRuntime(): boolean {
  ...
  return (
    Boolean(win.process?.versions?.electron) || window.navigator.userAgent.includes("Electron")
  );
}
