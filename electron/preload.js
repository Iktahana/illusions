...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  openCreateProjectDialog: invokeChannel(PROJECT_DIALOG_CHANNELS.invoke.open, { arity: 0 }),
  completeCreateProjectDialog: invokeChannel(PROJECT_DIALOG_CHANNELS.invoke.complete, { arity: 1 }),
  openRubyDialog: invokeChannel(RUBY_DIALOG_CHANNELS.invoke.open, { arity: 1 }),
  getRubyDialogRequest: invokeChannel(RUBY_DIALOG_CHANNELS.invoke.getRequest, { arity: 0 }),
  completeRubyDialog: invokeChannel(RUBY_DIALOG_CHANNELS.invoke.complete, { arity: 1 }),
  ...
  onMenuExportNote: eventChannel(MENU_CHANNELS.event.exportNote, { arity: 0 }),
  onMenuCopyTxt: eventChannel(MENU_CHANNELS.event.copyTxt, { arity: 0 }),
  onMenuCopyTxtRuby: eventChannel(MENU_CHANNELS.event.copyTxtRuby, { arity: 0 }),
  onMenuCopyNarou: eventChannel(MENU_CHANNELS.event.copyNarou, { arity: 0 }),
  onMenuCopyKakuyomu: eventChannel(MENU_CHANNELS.event.copyKakuyomu, { arity: 0 }),
  onMenuCopyAozora: eventChannel(MENU_CHANNELS.event.copyAozora, { arity: 0 }),
  onMenuCopyNote: eventChannel(MENU_CHANNELS.event.copyNote, { arity: 0 }),
