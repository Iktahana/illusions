...
export const SHORTCUT_REGISTRY: Record<CommandId, ShortcutEntry> = {
  ...
  "view.toggleWritingMode": {
    id: "view.toggleWritingMode",
    label: "縦書き／横書きを切り替え",
    category: "view",
    defaultBinding: { modifiers: ["Alt"], key: "v" },
    scope: "all",
  },
  "view.splitRight": {
    id: "view.splitRight",
  ...
  "panel.files": {
    ...
    label: "ファイルを切替",
    category: "panel",
    defaultBinding: { modifiers: ["CmdOrCtrl", "Shift"], key: "o" },
    scope: "all",
  },
  "panel.search": {
    id: "panel.search",
  ...
  "panel.dictionary": {
    ...
    label: "辞書を切替",
    category: "panel",
    defaultBinding: { modifiers: ["Ctrl", "Shift"], key: "d" },
    scope: "all",
  },
  "panel.wordfreq": {
    id: "panel.wordfreq",
    label: "語彙統計を切替",
    category: "panel",
    defaultBinding: { modifiers: ["Ctrl", "Shift"], key: "g" },
    scope: "all",
  },
  "terminal.new": {
    id: "terminal.new",
    label: "新規ターミナル",
    category: "panel",
    defaultBinding: { modifiers: ["Ctrl", "Shift"], key: "j" },
    scope: "electron-only",
  },
  "inspector.corrections": {
    id: "inspector.corrections",
    label: "校正パネルを表示",
    category: "panel",
    defaultBinding: { modifiers: ["Ctrl", "Shift"], key: "c" },
    scope: "all",
  },
  "inspector.stats": {
    id: "inspector.stats",
    label: "統計パネルを表示",
    category: "panel",
    defaultBinding: { modifiers: ["Ctrl", "Shift"], key: "i" },
    scope: "all",
  },
  "inspector.history": {
    ...
    label: "履歴パネルを表示",
    category: "panel",
    defaultBinding: { modifiers: ["Ctrl", "Shift"], key: "h" },
    scope: "all",
  },
