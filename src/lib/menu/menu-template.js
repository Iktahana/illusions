...
const SETTINGS_MENU_ITEM = {
  ...
  // Retained for the renderer's legacy/project-scoped modal listener. Native
  ...
  },
  {
    ...
    items: [
      ...
      SEPARATOR,
      {
        ...
        nativeAccelerator: "CmdOrCtrl+F",
        webAccelerator: "Ctrl+F",
        requiresActiveEditor: true,
        electronChannel: "menu-search",
      },
      {
        id: "search-next",
        label: "次を検索",
        nativeAccelerator: "CmdOrCtrl+G",
        webAccelerator: "Ctrl+G",
        requiresActiveEditor: true,
        electronChannel: "menu-search-next",
      },
      {
        id: "search-previous",
        label: "前を検索",
        nativeAccelerator: "CmdOrCtrl+Shift+G",
        webAccelerator: "Shift+Ctrl+G",
        requiresActiveEditor: true,
        electronChannel: "menu-search-previous",
      },
      {
        id: "replace",
        label: "置換...",
  ...
  },
  {
    ...
    items: [
      ...
      { ...SEPARATOR, webVisible: false },
      {
        ...
        commandId: "format.tcy",
        nativeAccelerator: TCY_COMMAND?.accelerator,
        requiresActiveEditor: true,
        webVisible: false,
        electronChannel: "menu-editor-command",
        electronArgs: ["format.tcy"],
      },
      { ...SEPARATOR, webVisible: false },
      {
