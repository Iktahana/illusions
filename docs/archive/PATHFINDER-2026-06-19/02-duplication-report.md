...
| `platform/browser/storage.ts` and `platform/electron-renderer/storage.ts` | IndexedDB and Electron/SQLite adapters are legitimate platform implementations of one contract.                                                               |
